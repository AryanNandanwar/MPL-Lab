...
class FreelancerOption extends StatefulWidget {
  const FreelancerOption({super.key});

  @override
  State<FreelancerOption> createState() => _FreelancerOptionState();
}

class _FreelancerOptionState extends State<FreelancerOption> {
